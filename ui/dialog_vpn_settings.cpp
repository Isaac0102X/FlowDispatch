...
//     ui->vpn_implementation->setCurrentIndex(
//         NekoGui::dataStore->vpn_implementation);
...
void DialogVPNSettings::accept()
    ...
    //     mtu = 9000;
    // NekoGui::dataStore->vpn_implementation =
    //     ui->vpn_implementation->currentIndex();
...
void DialogVPNSettings::on_troubleshooting_clicked()
    ...
    //     tr("If you have trouble starting VPN, you can force reset nekobox_core "
    //        "process here.\n\n"
    //        "If still not working, see documentation for more information.\n"
    //        "https://matsuridayo.github.io/n-configuration/#vpn-tun"),
    //     tr("Reset"), tr("Cancel"), "", 1, 1);
    // if (r == 0)
    //     {
